...
function() {
    ...
    $(document).ready(function() {
        ...
        // Add an update link
        $("#thread-interactions span:last-child").append("<span id='updater'><a href='#' id='update_thread'>[" + _("Update") + "]</a> (<input type='checkbox' id='auto_update_status'> " + _("Auto") + ") <span id='update_secs'></span></span>");
                        ...
                        if ($('#' + id).length == 0) {
                            if (!new_posts) {
                                ...
                                if (notify === "all" || (notify === "mention" && $(this).find('.own_post').length)) {
                                    ...
                                    var n = new Notification("New reply to " + $('title').text(), {
                                        body: $('<div/>').html(body).text()
                                    });
                                }
                            }
