 ...
 */
	...
	$config['additional_javascript'][] = 'js/inline-expanding.js';
	$config['additional_javascript'][] = 'js/toggle/expand-too-long.js';
	$config['additional_javascript'][] = 'js/toggle/expand-video.js';
	$config['additional_javascript'][] = 'js/toggle/expand.js';
	$config['additional_javascript'][] = 'js/toggle/toggle-images.js';
